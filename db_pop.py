...
def populate_dummy_data():
    ...
    # Insert blogs
    blogs = [
        ('Intro to AI', 'blog-1-intro-to-ai', '2025-04-01', '<p>Artificial Intelligence (AI) is the simulation of human intelligence in machines that are programmed to think like humans and mimic their actions.</p><img src="/content/blog-images/blog-1-image-1.jpg" alt="AI Concept Image"><p>Over the years, AI has evolved from simple rule-based systems to complex neural networks capable of deep learning and decision making.</p><img src="/content/blog-images/blog-1-image-2.jpg" alt="Neural Network Visualization"><p>Today, AI is applied in numerous fields such as healthcare, finance, transportation, and entertainment, transforming industries and our daily lives.</p><p>As AI technology progresses, it also brings ethical challenges and questions about its impact on employment, privacy, and society at large.</p>'),
        ('Deep Learning Advances', 'blog-2-deep-learning-advances', '2025-04-02', '''<p>Deep learning is a subset of machine learning that uses neural networks with many layers to learn from large amounts of data.</p><img src="/content/blog-images/blog-2-image-1.jpg" alt="Deep Learning Concept"><p>This article explores the most recent advancements in deep learning algorithms and their application in real-world problems, such as image recognition, language translation, and autonomous systems.</p><img src="/content/blog-images/blog-2-image-2.jpg" alt="Deep Learning in Action">'''),
        ('Computer Vision Techniques', 'blog-3-computer-vision-techniques', '2025-04-03', '''<p>Computer vision enables machines to interpret and understand the visual world. Using digital images from cameras, videos, and sensors, machines can identify and process objects and scenes.</p><img src="/content/blog-images/blog-3-image-1.jpg" alt="Computer Vision Image"><p>This blog delves into the various techniques used in computer vision, including edge detection, object tracking, and image segmentation.</p><img src="/content/blog-images/blog-3-image-2.jpg" alt="Computer Vision Model">'''),
        ('Natural Language Processing', 'blog-4-natural-language-processing', '2025-04-04', '''<p>Natural Language Processing (NLP) involves teaching machines to understand, interpret, and respond to human language.</p><img src="/content/blog-images/blog-4-image-1.jpg" alt="NLP Concept Image"><p>This blog covers the latest NLP techniques such as sentiment analysis, named entity recognition, and language generation.</p><img src="/content/blog-images/blog-4-image-2.jpg" alt="NLP Text Processing">'''),
        ('Building Robots', 'blog-5-building-robots', '2025-04-05', '''<p>Building robots involves integrating hardware and software to create autonomous systems that can perform tasks without human intervention.</p><img src="/content/blog-images/blog-5-image-1.jpg" alt="Robot Construction Image"><p>This blog will guide you through the fundamental principles of building robots, from sensor integration to motion control.</p><img src="/content/blog-images/blog-5-image-2.jpg" alt="Robotics Construction Process">'''),
        ('Ethics in AI', 'blog-6-ethics-in-ai', '2025-04-06', '''<p>As artificial intelligence continues to evolve, ethical considerations surrounding its use and impact are becoming more important.</p><img src="/content/blog-images/blog-6-image-1.jpg" alt="AI Ethics Image"><p>This blog discusses the ethical dilemmas in AI, including bias in algorithms, privacy concerns, and the potential consequences of AI-driven decision-making.</p><img src="/content/blog-images/blog-6-image-2.jpg" alt="Ethics in AI Discussion">'''),
        ('Healthcare AI', 'blog-7-healthcare-ai', '2025-04-07', '''<p>AI has the potential to revolutionize healthcare by improving diagnosis, personalizing treatment, and optimizing healthcare workflows.</p><img src="/content/blog-images/blog-7-image-1.jpg" alt="Healthcare AI Image"><p>This blog discusses the impact of AI on healthcare, including applications in medical imaging, predictive analytics, and patient care.</p><img src="/content/blog-images/blog-7-image-2.jpg" alt="Healthcare AI Technology">'''),
        ('Autonomous Vehicles', 'blog-8-autonomous-vehicles', '2025-04-08', '''<p>Autonomous vehicles use sensors and AI algorithms to navigate and operate without human intervention.</p><img src="/content/blog-images/blog-8-image-1.jpg" alt="Autonomous Vehicle Image"><p>This blog explores the development of self-driving cars, the technologies that power them, and their potential to transform the transportation industry.</p><img src="/content/blog-images/blog-8-image-2.jpg" alt="Self-driving Car Technology">'''),
        ('Data Science Trends', 'blog-9-data-science-trends', '2025-04-09', '''<p>Data science is an interdisciplinary field that combines statistical analysis, machine learning, and big data techniques to extract meaningful insights from data.</p><img src="/content/blog-images/blog-9-image-1.jpg" alt="Data Science Trends Image"><p>This blog highlights the latest trends in data science, including automation in data analysis, AI-powered analytics, and the growing demand for data science professionals.</p><img src="/content/blog-images/blog-9-image-2.jpg" alt="Data Science Tools">'''),
        ('AI in Daily Life', 'blog-10-ai-in-daily-life', '2025-04-10', '''<p>AI is becoming an integral part of our daily lives, from virtual assistants to personalized recommendations.</p><img src="/content/blog-images/blog-10-image-1.jpg" alt="AI in Daily Life Image"><p>This blog explores the various applications of AI that enhance our daily activities, such as smart home devices, voice assistants, and AI-driven entertainment platforms.</p><img src="/content/blog-images/blog-10-image-2.jpg" alt="AI-Powered Apps">''')
    ]
